...
public class MainActivity extends AppCompatActivity {
    ...
    /*
            THis demo showcases the Activity Callback methods which are invoked by the System when An Activity
            go to transtion from on state to Another
     */
    ...
    /*
            onSaveInstanceState()
            This method is not guaranteed to be invoked by System all the time when an Activity instance is destroyed
            So be careful
